...
const vcM5: CourseModule = {
  ...
  quiz: [
    ...
    },
    {
      ...
      options: [
        'Security tools only become available after launch',
        'Later fixes are technically much harder to apply',
        'Insecure software looks identical to secure software',
    ...
    },
    {
      ...
      options: [
        ...
        'A password for software, letting the holder act as you',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        ...
        'Delete the file and the commit that contained the key',
    ...
    },
    {
      ...
      options: [
        ...
        'A loop or retry runs at machine speed with no ceiling',
        'Backups run at night and are charged separately',
        'Free tiers all reset at midnight',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'The speed of the visitor\'s own computer',
        'Differences in screen size and resolution',
        'Local files, sign-ins and test data that stay on your machine',
    ...
    },
    {
      ...
      options: [
        ...
        'You would like to add a second page to the website',
        'The app now moves money, or outsiders depend on it',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        ...
        'Because a few testers used it without incident',
