  ...
  quiz: [
    {
      ...
      options: [
        ...
        'Anything you have only ever done once before',
        'A weekly status summary you write the same way each time',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'That it works on your cleanest single example',
        'That it produces output of exactly the right length',
        'How it behaves on messy or incomplete input',
        'That it never uses any bullet points at all',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'Output varies between runs, so one result proves little',
        'Templates degrade after their very first use',
        'The first run always uses different settings',
        'Reliability can only be measured over hundreds of separate runs',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        ...
        'The number of times it has been used so far',
        'Its known failure cases and what to check first',
    ...
    },
    {
      ...
      options: [
        ...
        'Asking for a quoted sentence or section number',
        'Asking it to be as concise as it possibly can',
    ...
    },
    {
      ...
      options: [
        ...
        'You are writing software in prose, the ceiling of prompting',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        ...
        'A knowledge gap — the fix is supplying the information',
