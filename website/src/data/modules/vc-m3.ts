  ...
  quiz: [
    {
      ...
      options: [
        ...
        'With broken you know what you changed; with lost you do not',
    ...
    },
    {
      ...
      options: [
        'Every red message must be fixed before you continue',
        'Clear the panel, reproduce it, and read what appears',
        'Console messages are never relevant to real problems',
        'Report all of them together as a single bug',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'The booking page has stopped working properly again today',
        'Something went wrong with the form, can you please fix it',
        'It stopped working right after your most recent change',
        'I pressed Confirm, got a blank page, console says X',
      ],
      correct: 3,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        'It may have removed the failing check rather than fixed it',
        'Errors should always be left visible to your users',
        'It means the AI misunderstood the programming language',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'You had to ask for the same screen twice over',
        'The first version did not match the picture in your head',
        'You needed to read an error message once',
        'Fixing one thing keeps breaking other, unrelated things',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Abandon the project, since the idea was not viable',
        'Rebuild the entire project from scratch with a different description',
        'Buy a few hours of an engineer\'s time for that one blockage',
