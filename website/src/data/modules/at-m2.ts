  ...
  quiz: [
    {
      ...
      options: [
        'Adding polite phrasing and saying please',
        'Repeating the same prompt until a better answer comes back',
        'Giving it context, an example, and the format you want',
    ...
    },
    {
      ...
      options: [
        'Thinking you learned it because the explanation read easily',
        'Writing so quickly that you make careless mistakes',
        'Using vocabulary that is too advanced for the marker',
        'Reading a passage over and over until it loses all meaning',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        'Asking it to write your conclusion and then changing a few words',
    ...
    },
    {
      ...
      options: [
        ...
        'Detectors are unreliable and falsely accuse honest students',
        'Detection software cannot read handwritten work',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'AI writing is always worse than student writing',
        'It uses a surprising amount of energy',
        'It breaks the terms of service of most AI tools',
        'Writing is how you find out whether you understand',
      ],
      correct: 3,
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        'They cannot tell a wrong answer from a right one',
        'Beginners tend to write much longer prompts',
        'Introductory material is missing from the data',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'Generating revision questions for a class test',
      ],
      correct: 2,
    },
  ],
