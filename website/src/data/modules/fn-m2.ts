  ...
  quiz: [
    {
      ...
      options: [
        'The vendor, under its service agreement and its self-certification of the model',
        'The firm — responsibility for an outsourced activity does not transfer with the build',
        'Whichever party holds the training data behind the model',
        'Shared equally between the firm and the vendor once a service agreement allocating responsibility is signed',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'It removes exposure entirely, since a characteristic the model never observes cannot influence the outcome it produces',
        'It removes exposure in the EU but leaves it in place in the US',
        'It shifts exposure onto whichever provider supplied the data',
    ...
    },
    {
      ...
      options: [
        ...
        'Attribution methods are too computationally expensive to produce at decision volume',
        'Attribution charts disclose commercially sensitive model internals to the applicant',
        'Nothing — a per-case attribution chart is the standard form of an adverse action reason',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        'Ask the same team for a larger test dataset and a comparison against a published benchmark',
        ...
        'Approve conditionally, and schedule a second round of testing by the same build team once the model has been deployed',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'As a configuration change outside the scope of model governance, on the basis that the weights themselves were never altered',
        'As acceptable provided output quality looks unchanged in spot checks',
        'As requiring a full re-validation in every case, whatever the materiality of the change',
    ...
    },
    {
      ...
      options: [
        ...
        'Whether the protected characteristic was supplied as an input to the model, on the basis that a model which never saw it cannot have relied on it',
        'Whether headline approval rates can be recalibrated until the groups match',
