      ...
      slides: [
        {
          ...
          body: 'Since generative tools became widely available, a consistent pattern has emerged across multiple jurisdictions: filings submitted containing citations to authority that does not exist, discovered either by opposing counsel unable to locate the cases or by the court itself. The responses have included orders to show cause, monetary sanctions, referrals to disciplinary bodies, adverse findings recorded in published judgments, striking of the offending filing, and in some instances costs awarded against the responsible practitioner personally. Reported incidents have involved practitioners at a wide range of experience levels and firm sizes, and they have continued well after the risk became widely publicised. This is a documented and recurring phenomenon, not a single memorable episode.',
          bullets: [
