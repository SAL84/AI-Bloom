  ...
  quiz: [
    {
      ...
      options: [
        ...
        'It is generating probable text — there is no lookup step to fail',
        'It was fine-tuned to always provide an answer of some kind',
    ...
    },
    {
      ...
      options: [
        'Nothing — self-verification is a recognised control on output',
        'It uses extra tokens for no benefit at all',
        'The model cannot answer questions about its own previous output',
        'The model will typically confirm and elaborate rather than retract',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'The sheer number of fabricated citations in the filing',
        'The response — defending the citations rather than correcting them',
        'The seniority of the practitioner who signed the filing',
        'Whether the filing was made in a trial or an appellate court',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'None — grounding eliminates hallucination in legal research entirely',
        'Only the risk of the corpus being temporarily unavailable to query',
        'Only the risk of the tool citing secondary rather than primary sources',
        'The summary can misdescribe a holding, or the authority be overruled',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        ...
        'Relevant to the issue, persuasive on the facts, recent, well-reasoned',
        'Retrieved, summarised, formatted, and then filed',
        'Jurisdiction, court level, presiding judge, and outcome',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        'A case cited for a proposition that it does not actually support',
        'Authority that should have been found and cited but never was',
        'A correct case name paired with the wrong reporter reference entirely',
        'An authority that has been overruled since it was first published',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'Juniors develop stronger manual research skills over time',
        'Uniform compliance, because the policy is entirely unambiguous',
        'Increased reliance on external counsel for the research',
    ...
    },
    {
      ...
      options: [
        'Accept it as evidence the checks were performed and sign it off',
        'File it away with the matter and review it only if a problem arises later',
        'Independently verify a sample, since a record can be filled in unchecked',
        'Return it to the junior to have a second junior countersign it',
      ],
      correct: 2,
    },
  ],
