      ...
      lessons: [
        ...
        },
        {
          ...
          slides: [{
            ...
            body: 'When AI paints "a cat in a space suit," it isn\'t copying one picture from somewhere. During training, it studied millions of images and learned patterns: how fur looks, how helmets shine, how moonlight falls. Then it mixes those patterns into something new — like a chef who tasted a thousand dishes inventing a new recipe. But here\'s the tricky bit: many of those training images were made by human artists who were never asked and never paid. Some artists feel their style was taken without permission. It\'s a real debate, with caring people on both sides — worth talking about together.',
            bullets: [
      ...
      lessons: [
        ...
        },
        {
          ...
          slides: [{
            ...
            body: 'Voice-cloning scams have a brilliant, low-tech enemy: a family code word. Sit down together and pick a secret word — something silly nobody would ever guess, like "pickle-rocket." The rule: if anyone calls or messages asking for money, passwords, or urgent help, ask for the code word. Real mum knows it. A cloned voice doesn\'t. Then remember the golden move for any suspicious message: close it, and contact the real person using a number you already have — never the one inside the message. Scammers can fake a voice, but they can\'t fake your family\'s inside joke.',
            bullets: [
