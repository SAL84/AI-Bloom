  ...
  quiz: [
    {
      ...
      options: [
        'Extraction models are trained on more legal data than generative ones',
        'Extraction cannot hallucinate under any circumstances',
        'Generation is prohibited in most engagement letters',
        'The output points into a document you already hold',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Redlines cannot be exported in a form you can compare',
        'The changes that were applied will be formatted inconsistently',
        'A diff shows what changed, not what should have changed and did not',
        'The model will refuse to explain the reasoning behind its edits',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'For maximum precision, so that the output list stays short and quick to review',
        'For recall, accepting false positives and discarding them in human review',
        'To return only clauses scoring above a fixed confidence threshold',
        'To exclude the longest documents in the set to control cost',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'Defensibility came from documented, measurable method, not the technology',
        'Human review is no longer required once a protocol has been filed',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'Privilege turns on context outside the document, and a miss risks waiver',
        'Privileged documents are usually far longer than responsive ones',
        'Models are contractually barred from processing privileged material at all',
    ...
    },
    {
      ...
      options: [
        ...
        'Review depth is set by risk tier, assigned to a named person, and time-budgeted',
        'AI output is spot-checked whenever the reviewer has any concerns about its quality',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'The processing cost per document across the whole review',
        'How much of the model\'s available context window was used',
        'Whether the firm playbook had been correctly loaded before the run began',
        'Recall — what the tool missed, where the professional exposure sits',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Playbook wording expires after a set period and must be refreshed each year',
        'Matching clauses are excluded from the extraction index by default',
        'It may clash with a definition elsewhere, or be wrong for the deal',
