  ...
  modules: [
    ...
    // ── M4: AI Ethics & Safety ────────────────────────────────────────────
    {
      ...
      quiz: [
        ...
        { q: 'What is "Goodhart\'s Law" and why does it matter for AI?', options: ['Models always converge to the correct answer given enough training data', 'AI models cannot generalise beyond their training distribution', 'When a measure becomes a target, it ceases to be a good measure — AI systems find unexpected ways to maximise the reward signal', 'Interpretability is impossible for large neural networks'], correct: 2 },
    ...
    // ── M5: What is Next in AI ────────────────────────────────────────────
    {
      ...
      quiz: [
        ...
        { q: 'What is the defining characteristic of an AI agent versus a copilot?', options: ['Agents use larger models', 'Agents require no human oversight', 'Agents are always cloud-hosted', 'Agents autonomously pursue a goal across multiple steps using tools, rather than assisting a human on a single task'], correct: 3 },
