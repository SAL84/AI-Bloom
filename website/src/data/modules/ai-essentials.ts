          ...
          roleContent: [
            {
              role: 'general',
              label: 'General User',
              body: 'AI didn\'t suddenly appear — three long-running trends converged at the same moment to make it suddenly powerful. Understanding this helps you calibrate whether the current wave is real or another false start.',
              bullets: [
                'Data, compute, and algorithms compound — removing any one would have prevented the breakthrough',
                'The internet as an accidental training dataset explains the scale of modern AI capabilities',
                'This convergence explains why AI progress feels exponential rather than steady',
              ],
            },
            {
              role: 'security-se',
              label: 'Security SE',
              body: 'The three-factor convergence is your counter to "AI is just a trend" objections — each factor has an independent trajectory that isn\'t reversing.',
              bullets: [
                'Counter "this is a bubble" by pointing to each factor\'s independent trajectory: data grows, compute improves, algorithms compound',
                'Ask: which of the three factors do you think will reverse? The answer usually ends the objection',
                'The compounding dynamic explains why security AI is accelerating, not plateauing',
              ],
            },
            {
              role: 'developer',
              label: 'Developer',
              body: 'The three-factor model is your architecture context — more data, cheaper compute, and better algorithms all change the optimal technical approach over time.',
              bullets: [
                'Compute trends mean yesterday\'s prohibitively expensive model is today\'s affordable inference call',
                'Data availability is why pre-trained models beat from-scratch training for most tasks',
                'Algorithmic improvements (attention, RLHF) are the most underestimated factor — watch this axis most closely',
              ],
            },
            {
              role: 'consultant',
              label: 'AI Consultant',
              body: 'Clients who understand the structural drivers of AI capability can plan investments on a longer time horizon instead of reacting to individual product releases.',
              bullets: [
                'Use the three-factor model to project which AI capabilities become accessible within 12-24 months',
                'The compounding dynamic means client AI strategies need annual review, not 3-year planning cycles',
                'Data accumulation is the factor clients most directly control — make it a strategic priority',
              ],
            },
          ],
        },
