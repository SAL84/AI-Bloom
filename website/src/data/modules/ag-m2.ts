...
const agM2: CourseModule = {
  ...
  quiz: [
    ...
    { q: 'An agent stores memories freely at any step with no schema. What is the characteristic result?', options: ['Retrieval latency becomes the bottleneck', 'The store fills with transient details recorded as durable facts, and contradictions accumulate unresolved', 'Memories become impossible to write', 'The context window overflows on the first step'], correct: 1 },
