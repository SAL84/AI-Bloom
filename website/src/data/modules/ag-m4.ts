...
const agM4: CourseModule = {
  ...
  quiz: [
    ...
    { q: 'An agent repeatedly calls a tool name that does not exist. What is the most useful interpretation?', options: ['The model needs to be replaced with a larger one', 'The context window is too small', 'Tool validation should be disabled to let the call through', 'The invented name is a specification for a capability the agent needed and was not given'], correct: 3 },
