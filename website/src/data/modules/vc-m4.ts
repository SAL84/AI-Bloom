...
const vcM4: CourseModule = {
  ...
  icon: 'brain',
  summary: 'A practical, no-statistics way to know whether what you built actually works: a short list written before you build, run in full after every change, tested by someone who is not you — and extra care where an AI feature can be confidently wrong.',
  lessons: [
    {
      id: 'vc4l1',
      ...
      slides: [
        ...
        },
        {
          ...
          body: 'At least a couple of items should be things that must not happen, because these are the ones nobody notices when they break. "One user must never see another user\'s data." "Nothing is emailed to a customer without me pressing a button." "It must not let the same slot be booked twice." Positive checks confirm the thing you were looking at anyway; negative checks catch the failures that are invisible from the outside. Nobody complains about seeing data they should not have seen — they are not aware they should not have seen it. If a never-item is genuinely hard to check by hand, that is a signal the feature deserves more care than a prototype normally gets.',
          bullets: [
      ...
      slides: [
        {
          ...
          body: 'Here is the single most useful idea borrowed from professional practice, stripped of everything technical: after any change, check the whole list, not just the part you touched. It is tempting to test only the new bit — you changed the booking form, so you test the booking form. But an AI editing your project may adjust things elsewhere, and shared pieces get touched in ways you were not told about. The entire value of running the full list is catching the break you were not looking for. That is precisely the break that otherwise reaches a real user, because by definition it is in a place you had no reason to look.',
          bullets: [
        ...
        },
        {
          ...
          body: 'Run the list right after each change, while you still know what you did. If you make four changes and then check, a failure gives you four suspects and no way to choose between them, so you are back to guessing. Checked immediately, a failure has exactly one cause and the fix is usually obvious. This is the same habit as changing one thing at a time, seen from the other end, and together they form the core loop of building without being able to read the code: change one thing, check everything, save a copy, repeat. It is unglamorous and it is genuinely what makes the difference.',
          bullets: [
      ...
      slides: [
        {
          ...
          body: 'You know where to click. You know the form wants the date in a particular way, you know which button is the real one, you unconsciously avoid the three things that do not work. None of this is available to anyone else, and none of it is visible to you — the knowledge is invisible from the inside, which is exactly why your own testing is close to worthless for anything except confirming that the parts you built do what you meant. The only cure is to watch someone else use it. Not describe it to them, not demo it. Hand it over and be quiet.',
          bullets: [
        ...
        },
        {
          ...
          body: 'Give them a task, not a tour. "Book yourself a slot for next Tuesday" and then say nothing at all. The silence is the hard part and it is where all the information is: every moment they hesitate, hover, or ask "do I press this?" is a design problem you cannot see. Do not explain, do not rescue them, do not say "you just need to click the little one at the top". Write down where they paused. Ten minutes of this will teach you more than a day of your own clicking. Afterwards you can ask what they expected to happen at the moment they hesitated, which is usually more useful than asking what they thought of it.',
          bullets: [
        ...
        },
        {
          ...
          body: 'Your friends will be kind, and kindness is the enemy here. Try to find someone resembling the actual user, and set the framing to make criticism easy: "I need to find what is broken, so tell me every annoying thing." If you only have friends available, ask for specifics rather than opinions — "where did you hesitate?" gets more truth than "what do you think?". Watch what they do rather than trusting what they say, because people are polite and their hands are not. Someone who says it was fine while spending twenty seconds hunting for a button has told you two different things, and the hands are the one to believe.',
          bullets: [
      ...
      slides: [
        {
          ...
          body: 'The most dangerous sentence in prototype building is "it worked when I tried it". You tried it once, on your machine, on your network, with your data, in the way you had in mind, at a moment when nothing else was happening. That is a single observation under ideal conditions, and it tells you the thing is capable of working rather than that it does work. This is not a demand for rigour you do not have time for — it is simply noticing the difference between "I have seen it succeed" and "I have reason to believe it succeeds for other people". Those are genuinely different claims, and most prototype disappointment lives in the gap between them.',
          bullets: [
      ...
      slides: [
        {
          ...
          body: 'If your app uses AI to summarise, answer, classify or draft, you have added a component that fails differently from everything else in software. A broken button looks broken. A wrong summary looks like a summary. It will be well written, plausible and specific, and there is nothing on screen to distinguish it from a correct one. This matters most where users cannot check the answer themselves — which is usually why they are asking. Nothing here says avoid AI features. It says that "it gave a good answer when I tried it" is even weaker evidence here than elsewhere, because the failure mode is specifically designed to look fine.',
          bullets: [
        ...
        },
        {
          ...
          body: 'You do not need statistics to get useful evidence. Collect ten or twenty real examples — actual customer emails, actual documents, actual questions — and write down what a good answer would be for each. Then run them through and compare, by eye, one at a time. Do it again whenever you change the instructions you give the AI, because those changes have effects you will not predict. This is an afternoon of dull work and it is genuinely how the professional version starts too; the rigorous version differs in scale and measurement, not in the underlying idea of comparing output against answers you decided on in advance.',
          bullets: [
        ...
        },
        {
          ...
          body: 'The most effective protection is not better prompting, it is where you put the output. Keep AI results as drafts a person approves rather than actions taken automatically. Show the source, so someone can check. Make it easy to correct and easy to report. Never let an unreviewed AI output send an email to a customer, change a record, or make a decision about a person. And say plainly in the interface that the answer came from AI and may be wrong — users who know that read differently and catch things you never will. Designing for wrongness is cheaper and far more reliable than trying to eliminate it.',
          bullets: [
      ...
      roleContent: [
        {
          ...
          body: 'You will be tempted to trust the AI feature because it impressed you on the first few examples. That impression is exactly what the failure mode is good at producing.',
          bullets: [
            'Keep your twenty examples in a file and re-run them after every instruction change',
        ...
        },
        {
          ...
          body: 'Anything users type reaches the AI, and anything the AI produces reaches your screen. Both directions deserve a little suspicion before you let strangers in.',
          bullets: [
            'Assume users will paste instructions trying to make it behave differently — test that yourself',
        ...
        },
        {
          ...
          body: 'Keep your examples and expected answers in a file the project can run against, so re-checking is one command rather than an afternoon.',
          bullets: [
            'Store examples and expected answers as data, not in a chat history',
            'Pin what you can — instructions, settings, versions — so results are comparable',
            'The rigorous version of this is the Evals course; this is the prototype-scale entry point',
          ],
        },
        {
          role: 'consultant',
          label: 'If You Are Advising or Hiring',
          body: 'When someone shows you an AI feature, the useful question is not what it can do but how they know it is right — and asking early saves an awkward conversation later.',
          bullets: [
            'Ask what examples they tested against and what they expected before running them',
            'Ask what happens when it is wrong and who notices',
            'A feature that acts unattended on customers needs professional evaluation, not a checklist',
          ],
        },
      ],
    },
  ...
  quiz: [
    {
      ...
      options: [
        'A list written afterwards just describes what you happen to have built, so it tests nothing',
        'It is required by most AI building tools',
        'Lists are quicker to write when you know less about the project',
        'It makes the build itself faster',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        'Only the item covering that screen',
        'None — you already saw it working while you changed it',
        'All of them, because the value is catching the break you were not looking for',
        'Only the items that failed last time',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        ...
        'Because nobody reports seeing data they should not have seen — silent failures need deliberate checks',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Demonstrate it first so they understand how it works',
    ...
    },
    {
      ...
      options: [
        'That it is ready for other people to use',
        'That the remaining issues are only cosmetic',
        'That it is capable of working, under one set of ideal conditions, once',
    ...
    },
    {
      ...
      options: [
        'It only occurs under heavy load',
        'It appears in the console rather than on the page',
        'It always happens on the first request of the day',
        'It arrives looking exactly like a correct answer — fluent, specific and plausible',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Collect ten to twenty real examples, write the answer you would accept, and compare by eye after every change',
        'Ask the same AI whether its answer was correct',
        'Measure the average response length across a large sample',
        'Trust it until a user complains',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        ...
        'Keeping the output as a draft a person approves before anything happens',
