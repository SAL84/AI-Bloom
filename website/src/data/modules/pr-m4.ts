  ...
  quiz: [
    ...
    },
    {
      ...
      options: [
        ...
        'The task was too big — shrink the scope and chain the steps',
        'Fabrication — verify each claim',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        ...
        '"Keep the structure and section one as they are; replace section two with the decision and who owns it."',
    ...
    },
    {
      ...
      options: [
        ...
        'Something else in your prompt contradicts it, or the instruction is ambiguous',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        ...
        'Very little — models tend to yield to pushback, so a reversal is not evidence',
        'The model has learned from your correction for future users',
        'The original answer was fabricated',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'A general explanation of how interest rates affect borrowing',
        'A summary of a document you pasted in full',
        'A specific citation with authors, year and page number for a niche claim',
    ...
    },
    {
      ...
      options: [
        ...
        'Asking the same model whether it is certain',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Keep iterating, since each attempt is cheap',
        'Rephrase the same request more forcefully',
        'Stop prompting and change something structural — shrink the task, add information, change tool, or do it yourself',
