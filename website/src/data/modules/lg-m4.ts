  ...
  quiz: [
    {
      ...
      options: [
        ...
        'It still applies: supervising others and advising clients on AI-generated material both require understanding how these tools fail',
        'It requires them to adopt at least one approved tool',
    ...
    },
    {
      ...
      options: [
        'Only the response speed and usage limits',
        'Nothing material — the model is the same, so the confidentiality position is the same',
        'Only whether outputs may be used in court filings',
        'Retention, training use, human review, processing location, and audit rights can all differ materially',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Disclosure is now universally required in all filings',
        'Requirements vary by jurisdiction, court, and individual judge, and must be checked per forum before filing',
        'Disclosure is only required if the AI produced citations',
        'No court currently requires disclosure of AI use',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'Billing the two hours actually worked',
        'Converting the work to a fixed fee agreed with the client',
        'Billing six hours because that is what the work has historically been worth',
        'Discussing a revised pricing approach with the client',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'AI output is generally more accurate, so less supervision is required',
        'Supervision duties do not extend to software under most rules',
        'AI output can be validated automatically by a second model',
        'Errors are unpatterned, correction does not persist, and stated reasoning is generated text rather than a real account',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        ...
        'Circulate a prohibition until governance is ready',
        'Honestly survey what is already being used, by whom and for what, without penalty',
        'Adopt a published model policy from a bar association',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        ...
        'Withdraw from the matter to avoid the conflict',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        'A sanctioned alternative that is at least as fast and convenient as the unsanctioned one',
        'A clearly worded prohibition with disciplinary consequences',
        'Annual mandatory training on AI risk',
        'Blocking known AI domains on the firm network',
      ],
      correct: 0,
    },
  ],
