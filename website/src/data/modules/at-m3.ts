  ...
  quiz: [
    {
      ...
      options: [
        'Video files are compressed too heavily for glitches to appear',
        'Generators are improved to remove the flaws people notice',
        'Most fakes are audio-only, not video',
        'Glitches only show up on large screens',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        'Money earned from producing and selling deepfakes',
        'The advantage held by whoever posts first in a news cycle',
        'The benefit of being able to dismiss real evidence as fake',
    ...
    },
    {
      ...
      options: [
        'False claims became almost free to make and slow to check',
        'Fact-checkers are not allowed to use AI tools themselves',
        'False claims are usually written more clearly than true ones',
        'Social platforms cannot detect duplicated text at all',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        ...
        'An even spread of different viewpoints',
        'Content from the accounts you follow most closely',
        'Predicted engagement from users with your habits',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'Skimming the page quickly for the key claims',
        'Leaving the page to see what others say about it',
        'Comparing the headline against the body text',
        'Reading the comments before reading the article',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'It is definitely made up by someone',
        'It is unsupported and should not be shared as evidence',
    ...
    },
    {
      ...
      options: [
        'Ones that confirm what you believe',
        'Ones that come from unfamiliar websites',
        'Ones that involve numbers and statistics',
