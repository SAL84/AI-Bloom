...
const vcM2: CourseModule = {
  ...
  icon: 'target',
  summary: 'Writing a plain-language spec an AI can build from, adding one thing at a time, describing screens and flows so they come back recognisable, and reacting usefully when what arrives is not what you pictured.',
  lessons: [
    {
      id: 'vc2l1',
      ...
      slides: [
        ...
        },
        {
          ...
          body: 'Vagueness gets filled in with a guess, and the guess is usually a generic default. "Users can upload a file" leaves open which formats, how big, what happens to a wrong one, and whether anyone else can see it. "Users can upload a photo, up to about five megabytes, JPEG or PNG only, and see a clear message if it is the wrong type" leaves almost nothing open. You do not need to be specific about everything — be specific about anything where a wrong guess would annoy you. A useful habit is to say what happens when things go wrong as well as when they go right, because the unhappy paths are where generated software is thinnest and where real users spend a surprising amount of their time.',
          bullets: [
        ...
        },
        {
          ...
          body: 'End your spec with a short list of statements that must be true when it is finished. "A visitor can submit the form and I receive an email within a minute." "Nobody can see another person\'s submission." "It is readable on a phone." These are not decoration — they are how you tell whether you are done, and in module four they become the checklist you run every time you change anything. Write them before you build, while you still have clear eyes. Written afterwards, they mysteriously describe whatever the software happens to do, which tests nothing at all. Five to ten statements is plenty for a first version, and each one should be something you could check in under a minute.',
          bullets: [
        ...
        },
        {
          ...
          body: 'Once you have those pieces, paste the whole thing in as context and then ask for a small first piece of it. That combination matters. Without the spec, the AI is guessing at your intent and will fill the gaps with generic choices. Without the "small first piece", it will attempt the entire document at once and produce something broad and shallow that is very hard to correct. Keep the spec somewhere you can paste it again, because conversations lose earlier context and tools get restarted. Re-supplying the same clear description is not wasted effort; it is the cheapest way to keep everything you build pointing at the same idea rather than drifting a little further with each session.',
          bullets: [
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          body: 'Before you ask for the next change, save a copy of the version that works. How you do it matters less than that you do it — a duplicated folder with today\'s date is unglamorous and completely sufficient. Proper tools exist for this and are worth learning eventually, but an unfashionable copy you actually make beats an elegant system you never set up. The reason is simple: the single most valuable thing you can own when a change goes wrong is a version you know was fine. Without it, "go back" means reconstructing from memory, which does not work. With it, a bad afternoon costs you an afternoon rather than the whole project.',
          bullets: [
      ...
      slides: [
        {
          ...
          body: 'The most reliable way to describe a screen is to walk through it the way you would describe a room to someone on the phone. What is at the top, what is in the middle, what is at the bottom. What the person sees first, what they can press, what happens when they do. "A page with a heading, one box for an email address, and a green button that says Join. After pressing it the form disappears and a short thank-you message appears in its place." That is specific enough to build and short enough to write in twenty seconds. Compare it with "a clean modern signup page", which contains no information at all and will get you somebody else\'s idea of clean and modern.',
          bullets: [
        ...
        },
        {
          ...
          body: 'You do not have to describe common patterns from scratch, and you will do it worse than the conventions people already understand. Say "like a normal checkout" or "a two-column layout with the list on the left and the details on the right" or "the same sign-in flow every site uses". Referring to an established pattern communicates a great deal in a few words and produces something users already know how to operate. It is also fine to point at an existing site you like and describe the specific thing you want from it — "the way their pricing page lays out three tiers side by side". Be specific about which part you mean; "make it like theirs" without saying which aspect gets you a coin flip.',
          bullets: [
    ...
    },
    {
      ...
      slides: [
        ...
        },
        {
          ...
          body: 'Before reacting, sort what is wrong into three piles, because they need different responses. Wrong understanding: it built something else entirely, which means your description missed the point and needs rewriting rather than adjusting. Wrong details: the right thing with wrong specifics — wrong colour, wrong order, missing field — which is a small correction. Wrong behaviour: it looks right but does the wrong thing when used, which is the one to take most seriously because it hides. Mixing these up wastes time, most often by making repeated small tweaks to something that was built on a misunderstanding and needed restating from the top.',
          bullets: [
      ...
      slides: [
        {
          ...
          body: 'The single highest-value habit in this whole course is describing the difference between what you got and what you wanted, rather than passing judgement on it. "This is wrong" contains no information. "The list shows all bookings, but it should only show the ones for the selected date" contains everything needed. The pattern is: here is what I see, here is what I expected, here is the difference. It works for the same reason a good bug report works for a human colleague — a precise gap points at a precise change, while a complaint invites a guess. If you find you cannot describe the gap, that is genuinely useful information too: it means you have not yet decided what you wanted.',
          bullets: [
        ...
        },
        {
          ...
          body: 'When something is not right, the instinct is to wipe it and describe the whole thing again from scratch. Resist it. Starting over throws away everything that was already working and gives you a fresh set of unrelated problems, so you swap known issues for unknown ones. Ask for the specific change instead: keep everything else, change this one thing. Restarting is occasionally correct — when the whole approach was misunderstood, or when the code has become a tangle nobody can follow — but it should be a deliberate decision you can justify, not a reflex triggered by frustration. If you do restart, take the lesson with you and write it into the spec first, or you will arrive at the same place.',
          bullets: [
  ...
  quiz: [
    ...
    },
    {
      ...
      options: [
        'Because AI tools require them as input',
        'Because they are needed for legal compliance',
        'Because statements written afterwards simply describe whatever you happen to have built, so they test nothing',
        'Because they are harder to write later',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        'It uses fewer AI credits per session',
        'When something breaks there is exactly one recent change to suspect',
        'Small requests produce better-looking designs',
        'AI tools cannot process long instructions',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'Something on screen, then the core action end to end, then error cases, then appearance',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'A clean, modern, professional-looking page',
        'Something like the sites in my industry',
        'A heading, one email field, and a green Join button; after pressing it the form is replaced by a thank-you message',
        'Whatever layout works best for conversions',
      ],
      correct: 2,
    },
    {
      ...
      options: [
        ...
        'It costs more to fix than visual problems',
        'It is easier to fix than the other kinds',
        'Because it hides — nothing on screen signals that anything is wrong',
      ],
      correct: 3,
    },
    {
      ...
      options: [
        'This page is wrong, try again',
        'The list shows every booking, but it should only show bookings for the selected date',
        'Make it better and more intuitive',
        'Start over, this is not working',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'Stop and change the approach — the requirements may contradict each other or the tool may be wrong for this',
        'Accept the broken behaviour and ship it',
      ],
      correct: 2,
    },
  ],
