  ...
  quiz: [
    {
      ...
      options: [
        'The entire profession disappears within a decade',
        'Execution becomes cheaper while judgement about the work becomes more valuable',
        'Employment in that field always grows',
        'Only manual jobs are affected',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'Doing routine work was how people traditionally built the judgement needed to become experts',
    ...
    },
    {
      ...
      options: [
        ...
        'Pick something you will genuinely work hard at that builds transferable foundations',
        'Avoid any subject that AI can partly automate',
        'Choose the shortest qualification so you can enter the market sooner',
      ],
      correct: 1,
    },
    {
      ...
      options: [
        ...
        'Beginners use the tools less frequently',
        'Experts ask better questions and can immediately recognise a wrong answer',
    ...
    },
    {
      ...
      options: [
        ...
        'The speed of summarising a long document',
      ],
      correct: 0,
    },
    {
      ...
      options: [
        'Follow every major model release as it happens',
        'Track benchmark leaderboards weekly',
        'Rely on long-range predictions from well-known figures',
        'Pay attention when something becomes possible that genuinely was not before',
      ],
      correct: 3,
    },
  ],
