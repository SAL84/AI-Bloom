...
const META: Record<CourseId, {
  ...
  'ai-kids': {
    ...
    related: [
      ...
      { no: '06', title: 'Cybersec Sales', sub: 'When the kid grows up', color: '#2c6db0', view: { type: 'home', courseId: 'ai-cybersec-se' } },
    ],
  },
  'ai-essentials': {
    ...
    related: [
      ...
      { no: '05', title: 'AI in Industry', sub: 'Now you can read the field map', color: '#b78320', view: { type: 'industry' } },
  ...
  'ai-cybersec-se': {
    color: '#2c6db0', no: '06', kicker: 'Catalog №06 · Vertical track',
    level: 'Intermediate', duration: '3h',
